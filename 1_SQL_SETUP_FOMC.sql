...
CREATE OR REPLACE STAGE FED_LOGIC DIRECTORY = (ENABLE = TRUE);

--create stage fed;
CREATE OR REPLACE STAGE FED_PDF DIRECTORY = (ENABLE = TRUE);

--create stream on FED_PDF directory to capture when new files arrive
